...
#define SF_BREAK_PINCH			512// change angles slightly when hit by a bullet
#define SF_BREAK_BULCLIP		1024// prevent bullets from passing thru'
...
#define CVOXFILESENTENCEMAX		4089		// max number of sentences in game. NOTE: this must match

...
========================
	...
	This code is incomplete as it's partially ported from
...
public:
	...
	void EXPORT		VehicleTouch( CBaseEntity *pOther );
	...
	{
		pev->absmin = pev->origin + Vector( -200, -200, -64 );
		pev->absmax = pev->origin + Vector( 200, 200, 96 );

...
constexpr char *szPlayerKickLines[] =
{
...
constexpr char *szPlayerEmptyKickLines[] =
{
...
constexpr char *szPlayerEmptyKickAirLines[] =
{
	"player/talk/kea_ninja.wav",
	"player/talk/kea_flyingdickman.wav"
};

constexpr char *szPlayerRandomLines[] =
{
...
constexpr char *szPlayerHurtLines[] =
{
...
constexpr char *szPlayerAttackKillLines[] =
{
...
void ClientCommand( edict_t *pEntity )
{
	...
	else if (FStrEq(pcmd, "legkick"))
	{
		CBasePlayer * pPlayer = GetClassPtr((CBasePlayer *)pev);

		if (!pPlayer->m_fKickTime)
			pPlayer->m_fKickTime = 1;
	}
...
// player pain sounds
	...
	PRECACHE_SOUND( szPlayerAttackKillLines[ 0 ] );
	PRECACHE_SOUND( szPlayerAttackKillLines[ 1 ] );
	PRECACHE_SOUND( szPlayerAttackKillLines[ 2 ] );

	PRECACHE_SOUND( szPlayerEmptyKickAirLines[ 0 ] );
	PRECACHE_SOUND( szPlayerEmptyKickAirLines[ 1 ] );

	PRECACHE_SOUND( szPlayerEmptyKickLines[ 0 ] );
	PRECACHE_SOUND( szPlayerEmptyKickLines[ 1 ] );
	PRECACHE_SOUND( szPlayerEmptyKickLines[ 2 ] );

	PRECACHE_SOUND( szPlayerHurtLines[ 0 ] );
	PRECACHE_SOUND( szPlayerHurtLines[ 1 ] );
	PRECACHE_SOUND( szPlayerHurtLines[ 2 ] );

	PRECACHE_SOUND( szPlayerKickLines[ 0 ] );
	PRECACHE_SOUND( szPlayerKickLines[ 1 ] );
	PRECACHE_SOUND( szPlayerKickLines[ 2 ] );
	PRECACHE_SOUND( szPlayerKickLines[ 3 ] );

	PRECACHE_SOUND( szPlayerRandomLines[ 0 ] );
	PRECACHE_SOUND( szPlayerRandomLines[ 1 ] );
	PRECACHE_SOUND( szPlayerRandomLines[ 2 ] );
	PRECACHE_SOUND( szPlayerRandomLines[ 3 ] );
	PRECACHE_SOUND( szPlayerRandomLines[ 4 ] );

	// special kicking model and "null" model for weapon_nothing

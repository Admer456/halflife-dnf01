...
//#include "vehicles/CVehicleBase.h"
...
#define PLAYER_FALL_PUNCH_THRESHHOLD (float)200 // won't punch player's screen/make scrape noise unless player falling at least this fast.
...
// these are time-sensitive things that we keep track of
	...
	BOOL			m_fKickTime; // time to kick some ass :3
	float			m_flKickClock = 0;
...
//	virtual void Think( void );
	...
	BOOL HasActiveWeapon(void);
	BOOL HolsterActiveWeapon(void);
	...
	void PlayerMonologue( char **szPath, float flChance, int iMaxIndex, int iSpecificLine = -1 );

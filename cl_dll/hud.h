...
//-----------------------------------------------------
//
class CHudKick : public CHudBase
{
public:
	int Init(void);
	int VidInit(void);
	...
	int MsgFunc_Kick(const char *pszName, int iSize, void *pbuf);
	int MsgFunc_KickShake(const char *pszName, int iSize, void *pbuf);
...
//-----------------------------------------------------
//
class CHudPlayerMonologue : public CHudBase
{
public:
	int Init( void );
	int VidInit( void );
...
//	void Think( void );
	...
	int MsgFunc_PlayerTalk( const char *pszName, int iSize, void *pbuf );
};
...
public:
	...
	int Draw(float flTime);
	void Reset( void );
	int MsgFunc_aFlashlight(const char *pszName,  int iSize, void *pbuf );
...
public:
	...
	CHudKick		m_Kick;
	CHudPlayerMonologue m_PlayerMonologue;
	CHudFlashlight	m_aFlash;
	CHudAmmo		m_Ammo;
	CHudHealth		m_Health;
